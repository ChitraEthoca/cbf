...
public class TestData {
	...
	// itc email login details

	@FindBy(xpath = "//a[contains(text(),'click here.')]")
	public static WebElement clickHerelnk;
	...
	@FindBy(xpath = "//span[contains(text(),'Outlook_WebAccess')]")
	public static WebElement outlookLnk;
	...
	public static WebElement outlookSignIN;
		
	@FindBy(xpath = "//span[contains(text(),'Search mail and people')]//..")
	public static WebElement searchemailInputBox;

	@FindBy(xpath = "(//*[@class=\"MsoNormal\"])[position()=9]")
	public static WebElement lnkGestampTest;
	
	//OK button
	@FindBy(xpath="//*[@id='_ariaId_107']") public static WebElement btnOK;
